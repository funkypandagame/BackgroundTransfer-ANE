...
public class DownloadManager {
	...
	public boolean cancel(int downloadId) {
        return mDownloadRequestQueue.cancel(downloadId);
	}

	/**
	 * Cancel the download according to download id.
	 *
	 * @param downloadURL download URL. Case sensitive
	 */
	public boolean cancel(String downloadURL) {
		return mDownloadRequestQueue.cancel(downloadURL);
	}
